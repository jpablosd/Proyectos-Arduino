...
byte server[] = { 192,168,1,176 }; // Direccion ip del servidor
...
const int inPin = 2;  // sensor conectado a la entrada analoga 0
...
void loop()
{
  ...
  if (client.connect(server,80)>0) {  // Se conecta al servidor
    client.print("GET /demomayo29/arduino.php?id=joniuz&n=t&v="); // Envia los datos utilizando GET
