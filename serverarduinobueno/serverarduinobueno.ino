...
byte ip[] = { 192,168,0,200 }; // Direccion ip local
byte server[] = { 192,168,0,101 }; // Direccion ip del servidor
...
void loop()
{
  ...
  if (client.connect(server,80)>0) {  // Se conecta al servidor    
    ...
    FECHA
    */
    client.print("GET /arduino/arduino.php?id_habitacion=1"); // Envia los datos utilizando GET
